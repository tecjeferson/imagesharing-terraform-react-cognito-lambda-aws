...
class GetIdentityPoolRolesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetIdentityPoolRolesInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetIdentityPoolRolesResponse.filterSensitiveLog,
        };
