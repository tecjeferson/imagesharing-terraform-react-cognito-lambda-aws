...
class GetCredentialsForIdentityCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCredentialsForIdentityInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCredentialsForIdentityResponse.filterSensitiveLog,
        };
