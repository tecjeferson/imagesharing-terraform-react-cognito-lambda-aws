...
exports.serializeAws_restJson1CreateRecommenderConfigurationCommand = async (input, context) => {
    const headers = {
        "Content-Type": "application/json",
    };
...
exports.serializeAws_restJson1DeleteRecommenderConfigurationCommand = async (input, context) => {
    const headers = {
        "Content-Type": "",
    };
...
exports.serializeAws_restJson1GetApplicationDateRangeKpiCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign(Object.assign(Object.assign({}, (input.StartTime !== undefined && {
...
exports.serializeAws_restJson1GetAppsCommand = async (input, context) => {
    ...
    let resolvedPath = "/v1/apps";
    const query = Object.assign(Object.assign({}, (input.Token !== undefined && { token: input.Token })), (input.PageSize !== undefined && { "page-size": input.PageSize }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1GetCampaignDateRangeKpiCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign(Object.assign(Object.assign({}, (input.NextToken !== undefined && { "next-token": input.NextToken })), (input.StartTime !== undefined && {
        "start-time": (input.StartTime.toISOString().split(".")[0] + "Z").toString(),
...
exports.serializeAws_restJson1GetJourneyDateRangeKpiCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign(Object.assign(Object.assign({}, (input.PageSize !== undefined && { "page-size": input.PageSize })), (input.EndTime !== undefined && { "end-time": (input.EndTime.toISOString().split(".")[0] + "Z").toString() })), (input.StartTime !== undefined && {
        "start-time": (input.StartTime.toISOString().split(".")[0] + "Z").toString(),
...
exports.serializeAws_restJson1GetJourneyExecutionActivityMetricsCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign({}, (input.PageSize !== undefined && { "page-size": input.PageSize })), (input.NextToken !== undefined && { "next-token": input.NextToken }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1GetRecommenderConfigurationCommand = async (input, context) => {
    const headers = {
        "Content-Type": "",
    };
    let resolvedPath = "/v1/recommenders/{RecommenderId}";
...
exports.serializeAws_restJson1GetRecommenderConfigurationsCommand = async (input, context) => {
    const headers = {
        "Content-Type": "",
    };
    let resolvedPath = "/v1/recommenders";
...
exports.serializeAws_restJson1ListTemplatesCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign(Object.assign(Object.assign({}, (input.Prefix !== undefined && { prefix: input.Prefix })), (input.NextToken !== undefined && { "next-token": input.NextToken })), (input.TemplateType !== undefined && { "template-type": input.TemplateType })), (input.PageSize !== undefined && { "page-size": input.PageSize }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1UpdatePushTemplateCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign({}, (input.Version !== undefined && { version: input.Version })), (input.CreateNewVersion !== undefined && { "create-new-version": input.CreateNewVersion.toString() }));
    let body;
    if (input.PushNotificationTemplateRequest !== undefined) {
        body = serializeAws_restJson1PushNotificationTemplateRequest(input.PushNotificationTemplateRequest, context);
    }
...
exports.serializeAws_restJson1UpdateRecommenderConfigurationCommand = async (input, context) => {
    const headers = {
        "Content-Type": "application/json",
    };
    let resolvedPath = "/v1/recommenders/{RecommenderId}";
...
const deserializeAws_restJson1CreateAppCommandError = async (output, context) => {
    ...
    switch (errorCode) {
        ...
        case "com.amazonaws.pinpoint#PayloadTooLargeException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1PayloadTooLargeExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
...
exports.deserializeAws_restJson1CreateRecommenderConfigurationCommand = async (output, context) => {
    if (output.statusCode !== 201 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1DeleteRecommenderConfigurationCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1GetRecommenderConfigurationCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1GetRecommenderConfigurationsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1UpdateRecommenderConfigurationCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
const serializeAws_restJson1Activity = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.CUSTOM !== undefined && { CUSTOM: serializeAws_restJson1CustomMessageActivity(input.CUSTOM, context) })), (input.ConditionalSplit !== undefined && {
...
const serializeAws_restJson1CampaignCustomMessage = (input, context) => {
    return Object.assign({}, (input.Data !== undefined && { Data: input.Data }));
};
...
const serializeAws_restJson1CreateRecommenderConfigurationShape = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.Attributes !== undefined && {
...
const serializeAws_restJson1CustomDeliveryConfiguration = (input, context) => {
    return Object.assign(Object.assign({}, (input.DeliveryUri !== undefined && { DeliveryUri: input.DeliveryUri })), (input.EndpointTypes !== undefined && {
...
const serializeAws_restJson1CustomMessageActivity = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.DeliveryUri !== undefined && { DeliveryUri: input.DeliveryUri })), (input.EndpointTypes !== undefined && {
        EndpointTypes: serializeAws_restJson1ListOf__EndpointTypesElement(input.EndpointTypes, context),
...
const serializeAws_restJson1JourneyPushMessage = (input, context) => {
    return Object.assign({}, (input.TimeToLive !== undefined && { TimeToLive: input.TimeToLive }));
};
...
const serializeAws_restJson1JourneySMSMessage = (input, context) => {
    return Object.assign(Object.assign({}, (input.MessageType !== undefined && { MessageType: input.MessageType })), (input.SenderId !== undefined && { SenderId: input.SenderId }));
};
...
const serializeAws_restJson1WriteCampaignRequest = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.AdditionalTreatments !== undefined && {
...
const serializeAws_restJson1WriteTreatmentResource = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.CustomDeliveryConfiguration !== undefined && {
        CustomDeliveryConfiguration: serializeAws_restJson1CustomDeliveryConfiguration(input.CustomDeliveryConfiguration, context),
    })), (input.MessageConfiguration !== undefined && {
        MessageConfiguration: serializeAws_restJson1MessageConfiguration(input.MessageConfiguration, context),
...
const deserializeAws_restJson1ListOfRecommenderConfigurationResponse = (output, context) => {
    return (output || []).map((entry) => deserializeAws_restJson1RecommenderConfigurationResponse(entry, context));
};
