...
class UpdateApnsSandboxChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateApnsSandboxChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateApnsSandboxChannelResponse.filterSensitiveLog,
        };
