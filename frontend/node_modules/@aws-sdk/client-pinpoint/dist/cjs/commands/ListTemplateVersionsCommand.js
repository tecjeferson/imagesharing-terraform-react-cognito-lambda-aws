...
class ListTemplateVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListTemplateVersionsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListTemplateVersionsResponse.filterSensitiveLog,
        };
