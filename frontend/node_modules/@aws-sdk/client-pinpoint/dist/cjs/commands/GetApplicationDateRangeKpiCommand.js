...
class GetApplicationDateRangeKpiCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetApplicationDateRangeKpiRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetApplicationDateRangeKpiResponse.filterSensitiveLog,
        };
