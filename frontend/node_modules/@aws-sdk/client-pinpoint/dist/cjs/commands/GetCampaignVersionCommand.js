...
class GetCampaignVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCampaignVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCampaignVersionResponse.filterSensitiveLog,
        };
