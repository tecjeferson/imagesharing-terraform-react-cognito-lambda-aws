...
class CreateVoiceTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateVoiceTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateVoiceTemplateResponse.filterSensitiveLog,
        };
