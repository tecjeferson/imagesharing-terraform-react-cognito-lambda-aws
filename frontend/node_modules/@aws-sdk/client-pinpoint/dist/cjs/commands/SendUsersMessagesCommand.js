...
class SendUsersMessagesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.SendUsersMessagesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.SendUsersMessagesResponse.filterSensitiveLog,
        };
