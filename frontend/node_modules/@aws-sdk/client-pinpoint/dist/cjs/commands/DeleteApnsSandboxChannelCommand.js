...
class DeleteApnsSandboxChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteApnsSandboxChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteApnsSandboxChannelResponse.filterSensitiveLog,
        };
