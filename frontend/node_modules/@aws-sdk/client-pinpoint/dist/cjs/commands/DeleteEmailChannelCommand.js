...
class DeleteEmailChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteEmailChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteEmailChannelResponse.filterSensitiveLog,
        };
