...
class UpdateVoiceTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateVoiceTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateVoiceTemplateResponse.filterSensitiveLog,
        };
