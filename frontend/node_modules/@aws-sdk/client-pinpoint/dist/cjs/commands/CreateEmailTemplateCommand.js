...
class CreateEmailTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateEmailTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateEmailTemplateResponse.filterSensitiveLog,
        };
