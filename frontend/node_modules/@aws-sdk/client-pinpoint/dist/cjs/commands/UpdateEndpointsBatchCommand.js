...
class UpdateEndpointsBatchCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateEndpointsBatchRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateEndpointsBatchResponse.filterSensitiveLog,
        };
