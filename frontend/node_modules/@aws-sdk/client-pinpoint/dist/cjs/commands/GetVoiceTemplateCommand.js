...
class GetVoiceTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetVoiceTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetVoiceTemplateResponse.filterSensitiveLog,
        };
