...
class RemoveAttributesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.RemoveAttributesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.RemoveAttributesResponse.filterSensitiveLog,
        };
