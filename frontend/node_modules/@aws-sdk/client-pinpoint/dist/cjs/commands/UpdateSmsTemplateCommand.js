...
class UpdateSmsTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateSmsTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateSmsTemplateResponse.filterSensitiveLog,
        };
