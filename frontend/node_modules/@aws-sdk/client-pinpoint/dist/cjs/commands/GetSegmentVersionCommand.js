...
class GetSegmentVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSegmentVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSegmentVersionResponse.filterSensitiveLog,
        };
