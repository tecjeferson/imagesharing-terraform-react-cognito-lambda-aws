...
class GetCampaignVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCampaignVersionsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCampaignVersionsResponse.filterSensitiveLog,
        };
