...
class GetSegmentImportJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSegmentImportJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSegmentImportJobsResponse.filterSensitiveLog,
        };
