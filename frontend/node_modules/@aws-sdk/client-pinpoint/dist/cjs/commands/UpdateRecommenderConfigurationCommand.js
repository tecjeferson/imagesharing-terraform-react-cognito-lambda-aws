...
class UpdateRecommenderConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateRecommenderConfigurationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateRecommenderConfigurationResponse.filterSensitiveLog,
        };
