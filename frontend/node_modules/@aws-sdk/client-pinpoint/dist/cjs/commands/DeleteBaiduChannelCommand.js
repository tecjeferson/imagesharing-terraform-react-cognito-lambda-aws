...
class DeleteBaiduChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteBaiduChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteBaiduChannelResponse.filterSensitiveLog,
        };
