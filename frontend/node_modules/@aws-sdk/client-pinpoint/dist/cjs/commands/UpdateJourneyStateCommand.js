...
class UpdateJourneyStateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateJourneyStateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateJourneyStateResponse.filterSensitiveLog,
        };
