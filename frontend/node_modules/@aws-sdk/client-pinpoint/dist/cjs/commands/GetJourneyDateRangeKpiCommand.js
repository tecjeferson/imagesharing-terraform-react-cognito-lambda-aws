...
class GetJourneyDateRangeKpiCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetJourneyDateRangeKpiRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetJourneyDateRangeKpiResponse.filterSensitiveLog,
        };
