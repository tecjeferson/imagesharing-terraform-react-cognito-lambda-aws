...
class DeleteEmailTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteEmailTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteEmailTemplateResponse.filterSensitiveLog,
        };
