...
class CreateSmsTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateSmsTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateSmsTemplateResponse.filterSensitiveLog,
        };
