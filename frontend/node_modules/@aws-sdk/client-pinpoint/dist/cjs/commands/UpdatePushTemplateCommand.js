...
class UpdatePushTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdatePushTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdatePushTemplateResponse.filterSensitiveLog,
        };
