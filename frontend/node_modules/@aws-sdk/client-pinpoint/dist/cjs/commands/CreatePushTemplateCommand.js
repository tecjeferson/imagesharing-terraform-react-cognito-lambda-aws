...
class CreatePushTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreatePushTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreatePushTemplateResponse.filterSensitiveLog,
        };
