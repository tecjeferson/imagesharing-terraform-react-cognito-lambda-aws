...
class PhoneNumberValidateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.PhoneNumberValidateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.PhoneNumberValidateResponse.filterSensitiveLog,
        };
