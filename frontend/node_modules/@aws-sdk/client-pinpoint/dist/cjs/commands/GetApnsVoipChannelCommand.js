...
class GetApnsVoipChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetApnsVoipChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetApnsVoipChannelResponse.filterSensitiveLog,
        };
