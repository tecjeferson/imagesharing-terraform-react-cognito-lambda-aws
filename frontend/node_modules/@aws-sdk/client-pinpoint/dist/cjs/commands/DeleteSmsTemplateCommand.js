...
class DeleteSmsTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteSmsTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteSmsTemplateResponse.filterSensitiveLog,
        };
