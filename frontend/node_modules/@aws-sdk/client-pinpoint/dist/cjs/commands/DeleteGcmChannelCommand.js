...
class DeleteGcmChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteGcmChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteGcmChannelResponse.filterSensitiveLog,
        };
