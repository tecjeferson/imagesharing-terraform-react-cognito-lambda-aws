...
class DeleteVoiceChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteVoiceChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteVoiceChannelResponse.filterSensitiveLog,
        };
