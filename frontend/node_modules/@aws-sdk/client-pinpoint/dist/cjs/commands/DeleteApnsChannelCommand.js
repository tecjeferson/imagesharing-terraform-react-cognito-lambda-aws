...
class DeleteApnsChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteApnsChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteApnsChannelResponse.filterSensitiveLog,
        };
