...
class GetRecommenderConfigurationsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetRecommenderConfigurationsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetRecommenderConfigurationsResponse.filterSensitiveLog,
        };
