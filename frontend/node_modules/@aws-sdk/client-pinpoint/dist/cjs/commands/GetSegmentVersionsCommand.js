...
class GetSegmentVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSegmentVersionsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSegmentVersionsResponse.filterSensitiveLog,
        };
