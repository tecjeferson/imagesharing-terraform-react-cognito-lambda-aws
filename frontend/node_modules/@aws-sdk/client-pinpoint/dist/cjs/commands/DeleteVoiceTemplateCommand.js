...
class DeleteVoiceTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteVoiceTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteVoiceTemplateResponse.filterSensitiveLog,
        };
