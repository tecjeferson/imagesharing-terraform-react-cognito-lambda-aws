...
class DeleteRecommenderConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteRecommenderConfigurationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteRecommenderConfigurationResponse.filterSensitiveLog,
        };
