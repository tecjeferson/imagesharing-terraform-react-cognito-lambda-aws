...
class GetJourneyExecutionActivityMetricsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetJourneyExecutionActivityMetricsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetJourneyExecutionActivityMetricsResponse.filterSensitiveLog,
        };
