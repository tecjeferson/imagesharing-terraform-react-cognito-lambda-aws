...
class GetJourneyExecutionMetricsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetJourneyExecutionMetricsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetJourneyExecutionMetricsResponse.filterSensitiveLog,
        };
