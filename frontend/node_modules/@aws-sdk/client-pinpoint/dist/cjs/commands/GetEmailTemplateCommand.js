...
class GetEmailTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetEmailTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetEmailTemplateResponse.filterSensitiveLog,
        };
