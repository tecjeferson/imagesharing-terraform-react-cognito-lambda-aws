...
class DeletePushTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeletePushTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeletePushTemplateResponse.filterSensitiveLog,
        };
