...
class CreateRecommenderConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateRecommenderConfigurationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateRecommenderConfigurationResponse.filterSensitiveLog,
        };
