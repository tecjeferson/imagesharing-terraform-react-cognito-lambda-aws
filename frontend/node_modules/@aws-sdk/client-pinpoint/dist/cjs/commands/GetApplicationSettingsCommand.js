...
class GetApplicationSettingsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetApplicationSettingsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetApplicationSettingsResponse.filterSensitiveLog,
        };
