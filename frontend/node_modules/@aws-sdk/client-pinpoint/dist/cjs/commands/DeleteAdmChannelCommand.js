...
class DeleteAdmChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteAdmChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteAdmChannelResponse.filterSensitiveLog,
        };
