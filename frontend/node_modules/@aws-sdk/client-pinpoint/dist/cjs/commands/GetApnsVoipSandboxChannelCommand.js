...
class GetApnsVoipSandboxChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetApnsVoipSandboxChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetApnsVoipSandboxChannelResponse.filterSensitiveLog,
        };
