...
class DeleteSmsChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteSmsChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteSmsChannelResponse.filterSensitiveLog,
        };
