...
class UpdateSmsChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateSmsChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateSmsChannelResponse.filterSensitiveLog,
        };
