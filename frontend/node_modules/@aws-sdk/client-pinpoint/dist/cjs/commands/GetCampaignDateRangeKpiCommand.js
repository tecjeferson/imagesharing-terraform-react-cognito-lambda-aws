...
class GetCampaignDateRangeKpiCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCampaignDateRangeKpiRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCampaignDateRangeKpiResponse.filterSensitiveLog,
        };
