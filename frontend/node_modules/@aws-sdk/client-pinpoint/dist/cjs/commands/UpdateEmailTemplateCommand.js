...
class UpdateEmailTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateEmailTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateEmailTemplateResponse.filterSensitiveLog,
        };
