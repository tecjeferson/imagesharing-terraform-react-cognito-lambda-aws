...
class GetSegmentExportJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSegmentExportJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSegmentExportJobsResponse.filterSensitiveLog,
        };
