...
class GetCampaignActivitiesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCampaignActivitiesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCampaignActivitiesResponse.filterSensitiveLog,
        };
