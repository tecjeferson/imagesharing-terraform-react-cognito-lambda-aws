...
class UpdateVoiceChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UpdateVoiceChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UpdateVoiceChannelResponse.filterSensitiveLog,
        };
