...
class DescribeStreamConsumerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeStreamConsumerInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeStreamConsumerOutput.filterSensitiveLog,
        };
