...
class DisableEnhancedMonitoringCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DisableEnhancedMonitoringInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.EnhancedMonitoringOutput.filterSensitiveLog,
        };
