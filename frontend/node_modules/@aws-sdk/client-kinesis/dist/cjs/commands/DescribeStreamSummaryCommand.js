...
class DescribeStreamSummaryCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeStreamSummaryInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeStreamSummaryOutput.filterSensitiveLog,
        };
