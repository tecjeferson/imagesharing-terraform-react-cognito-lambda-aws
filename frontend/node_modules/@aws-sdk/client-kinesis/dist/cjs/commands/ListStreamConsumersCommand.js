...
class ListStreamConsumersCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListStreamConsumersInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListStreamConsumersOutput.filterSensitiveLog,
        };
