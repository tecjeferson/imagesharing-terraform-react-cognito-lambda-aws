...
class RegisterStreamConsumerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.RegisterStreamConsumerInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.RegisterStreamConsumerOutput.filterSensitiveLog,
        };
