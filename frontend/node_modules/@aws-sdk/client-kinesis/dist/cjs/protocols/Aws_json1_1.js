...
const serializeAws_json1_1AddTagsToStreamInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.StreamName !== undefined && { StreamName: input.StreamName })), (input.Tags !== undefined && { Tags: serializeAws_json1_1TagMap(input.Tags, context) }));
};
...
const serializeAws_json1_1DecreaseStreamRetentionPeriodInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.RetentionPeriodHours !== undefined && { RetentionPeriodHours: input.RetentionPeriodHours })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
const serializeAws_json1_1DeleteStreamInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.EnforceConsumerDeletion !== undefined && { EnforceConsumerDeletion: input.EnforceConsumerDeletion })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
const serializeAws_json1_1DeregisterStreamConsumerInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.ConsumerARN !== undefined && { ConsumerARN: input.ConsumerARN })), (input.ConsumerName !== undefined && { ConsumerName: input.ConsumerName })), (input.StreamARN !== undefined && { StreamARN: input.StreamARN }));
};
...
const serializeAws_json1_1DescribeStreamInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.ExclusiveStartShardId !== undefined && { ExclusiveStartShardId: input.ExclusiveStartShardId })), (input.Limit !== undefined && { Limit: input.Limit })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
...
const serializeAws_json1_1GetRecordsInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.Limit !== undefined && { Limit: input.Limit })), (input.ShardIterator !== undefined && { ShardIterator: input.ShardIterator }));
};
...
const serializeAws_json1_1ListStreamsInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.ExclusiveStartStreamName !== undefined && { ExclusiveStartStreamName: input.ExclusiveStartStreamName })), (input.Limit !== undefined && { Limit: input.Limit }));
};
const serializeAws_json1_1ListTagsForStreamInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.ExclusiveStartTagKey !== undefined && { ExclusiveStartTagKey: input.ExclusiveStartTagKey })), (input.Limit !== undefined && { Limit: input.Limit })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
const serializeAws_json1_1MergeShardsInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.AdjacentShardToMerge !== undefined && { AdjacentShardToMerge: input.AdjacentShardToMerge })), (input.ShardToMerge !== undefined && { ShardToMerge: input.ShardToMerge })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
const serializeAws_json1_1MetricsNameList = (input, context) => {
    return input.map((entry) => entry);
};
const serializeAws_json1_1PutRecordInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (input.Data !== undefined && { Data: context.base64Encoder(input.Data) })), (input.ExplicitHashKey !== undefined && { ExplicitHashKey: input.ExplicitHashKey })), (input.PartitionKey !== undefined && { PartitionKey: input.PartitionKey })), (input.SequenceNumberForOrdering !== undefined && {
...
const serializeAws_json1_1PutRecordsRequestEntry = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.Data !== undefined && { Data: context.base64Encoder(input.Data) })), (input.ExplicitHashKey !== undefined && { ExplicitHashKey: input.ExplicitHashKey })), (input.PartitionKey !== undefined && { PartitionKey: input.PartitionKey }));
};
...
const serializeAws_json1_1RegisterStreamConsumerInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.ConsumerName !== undefined && { ConsumerName: input.ConsumerName })), (input.StreamARN !== undefined && { StreamARN: input.StreamARN }));
};
const serializeAws_json1_1RemoveTagsFromStreamInput = (input, context) => {
    return Object.assign(Object.assign({}, (input.StreamName !== undefined && { StreamName: input.StreamName })), (input.TagKeys !== undefined && { TagKeys: serializeAws_json1_1TagKeyList(input.TagKeys, context) }));
};
const serializeAws_json1_1SplitShardInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.NewStartingHashKey !== undefined && { NewStartingHashKey: input.NewStartingHashKey })), (input.ShardToSplit !== undefined && { ShardToSplit: input.ShardToSplit })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
const serializeAws_json1_1StartingPosition = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.SequenceNumber !== undefined && { SequenceNumber: input.SequenceNumber })), (input.Timestamp !== undefined && { Timestamp: Math.round(input.Timestamp.getTime() / 1000) })), (input.Type !== undefined && { Type: input.Type }));
};
const serializeAws_json1_1StartStreamEncryptionInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.EncryptionType !== undefined && { EncryptionType: input.EncryptionType })), (input.KeyId !== undefined && { KeyId: input.KeyId })), (input.StreamName !== undefined && { StreamName: input.StreamName }));
};
...
const serializeAws_json1_1UpdateShardCountInput = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.ScalingType !== undefined && { ScalingType: input.ScalingType })), (input.StreamName !== undefined && { StreamName: input.StreamName })), (input.TargetShardCount !== undefined && { TargetShardCount: input.TargetShardCount }));
};
