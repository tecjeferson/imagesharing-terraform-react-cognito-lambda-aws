...
class ListTagsForDeliveryStreamCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListTagsForDeliveryStreamInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListTagsForDeliveryStreamOutput.filterSensitiveLog,
        };
