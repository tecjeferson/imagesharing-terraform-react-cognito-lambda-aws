...
class ListDeliveryStreamsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListDeliveryStreamsInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListDeliveryStreamsOutput.filterSensitiveLog,
        };
