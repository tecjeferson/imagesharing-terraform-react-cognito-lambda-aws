...
class UntagDeliveryStreamCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.UntagDeliveryStreamInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.UntagDeliveryStreamOutput.filterSensitiveLog,
        };
