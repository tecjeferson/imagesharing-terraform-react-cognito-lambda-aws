...
class DeleteDeliveryStreamCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteDeliveryStreamInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteDeliveryStreamOutput.filterSensitiveLog,
        };
