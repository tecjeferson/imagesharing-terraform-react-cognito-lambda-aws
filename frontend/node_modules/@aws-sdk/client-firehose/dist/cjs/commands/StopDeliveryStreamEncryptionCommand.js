...
class StopDeliveryStreamEncryptionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopDeliveryStreamEncryptionInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopDeliveryStreamEncryptionOutput.filterSensitiveLog,
        };
