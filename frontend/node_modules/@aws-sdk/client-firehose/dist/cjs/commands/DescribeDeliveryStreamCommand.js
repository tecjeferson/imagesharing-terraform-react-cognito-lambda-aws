...
class DescribeDeliveryStreamCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeDeliveryStreamInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeDeliveryStreamOutput.filterSensitiveLog,
        };
